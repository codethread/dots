...
| [git-worktrees.md](./git-worktrees.md) | `oven/bin/wktree.ts`, `config/nushell/scripts/ct/git/worktree/`, `config/ct-worktrees/trees.toml` | `wktree` binary engine plus thin Nushell wrappers for worktree lifecycle, pooled slot allocation/recycling, and tmux session bootstrap |
