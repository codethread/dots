...
| Spec | Code | Purpose |
|---|---|---|
| [agentic-config.md](./agentic-config.md) | `nix/features/claude-code.nix`, `claude/`, `.claude/`, `config/codex/`, `home/.local/bin/cl`, `oven/bin/cc-hook--*.ts`, `oven/shared/claude-hooks.ts`, `home/.local/bin/cc-hook--*` | Claude Code & Codex declarative configuration: settings, hooks, agents, skills, plugins, wrappers |
