...
| [git-worktrees.md](./git-worktrees.md) | `config/nushell/scripts/ct/git/worktree/`, `config/ct-worktrees/trees.toml` | Git worktree lifecycle helpers plus repo-local post-create hooks and kitty-session bootstrap |
