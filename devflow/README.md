...
| [SPEC-002 cc-sandbox](./specs/cc-sandbox.md) | `home/.local/bin/cc-sandbox`, `home/.local/share/cc-sandbox/`, `oven/bin/cc-bridge.ts`, `config/nushell/scripts/ct/interactive/claude.nu` | Podman container isolation for headless Claude Code and Codex sessions |
