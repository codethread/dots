...
export def nix-wifi-setup [--ssid: string = "pie-fi", --env-file: path = "/etc/codethread/nm.env", --var: string = "PIFI_PSK"] {
...
export def nix-wifi-setup-debug [--env-file: path = "/etc/codethread/nm.env"] {
