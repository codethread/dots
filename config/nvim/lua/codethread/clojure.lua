...
--
-- The palette:
--   plain  (text)  symbols, strings, numbers, keyword names, def'd names
--   fn     (rose)  clojure.core builtins/macros + namespace aliases
--   paren  (muted) ( ) [ ] { } and reader punctuation
...
return {
	...
	['@function.clojure'] = { fg = 'iris' }, -- bare @function = the def'd name (no-LSP case)
	...
	['@lsp.typemod.function.definition.clojure'] = { fg = 'iris' }, -- the name at (defn foo …)
